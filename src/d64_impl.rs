...
impl Unpacked<u64> {
    pub(crate) fn round_and_pack<Ctx: crate::Context>(mut self) -> Decimal<u64, Ctx> {
        ...
        if digits > u64::COEFFICIENT_SIZE {
            let extra = digits - u64::COEFFICIENT_SIZE;
            let factor = u64::FACTORS[usize::from(extra)];
...
impl<Ctx: crate::Context> Add for Decimal<u64, Ctx> {
    ...
    fn add(self, rhs: Self) -> Self::Output {
        ...
        if diff_exp > u64::COEFFICIENT_SIZE {
            ...
            let factor = u64::FACTORS[usize::from(diff_exp)];
